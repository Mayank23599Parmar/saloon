        ...
        <div className='home-banner-section'>
            <div className="banner-bg-image bg-[url('/images/bg.png')] bg-cover bg-no-repeat bg-center relative">
             <div className='overlay bg-black absolute top-0 left-0 right-0 bottom-0 opacity-60'></div>
              <div className='home-page-search-block relative py-20'>
               <div className='max-w-[640px] mx-auto w-full px-4'>
                 <div className='title'>
                    ...
                    <h5 className='mb-6 text-[#ffffff80] font-normal text-base md:text-xl text-center'>Lists of top restaurants, cafes, pubs, and bars in Melbourne, based on trends</h5>
                 </div>
